...
// logAppenders.push({
//     type: 'file',
//     filename: 'logs/bossadmin.log',
//     category: 'bossadmin'
// })

log4js.configure({
    appenders: {
        appLogs: { type: 'file', filename: './logs/applog.log' },
        console: { type: 'console' }
    },
    categories: {
        lotteryApp: { appenders: ['appLogs', 'console'], level: 'trace' },
...
// })
const logger = log4js.getLogger('lotteryApp')
